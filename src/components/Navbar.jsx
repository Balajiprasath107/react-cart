...
function Navbar({cartcount,setcartCount,show,setShow,arryitem,setarrayitem}){
    ...
    <div>
         <nav className="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <button className="btn btn-outline-dark shadow-none me-5" type="submit" onClick={()=> setShow(!show)}>
          ...
          {show?<CartSpace arryitem={arryitem} setarrayitem={setarrayitem} cartcount={cartcount} setcartCount={setcartCount}  />:null}
    </div>
)
